...
function ITS_Milestone0 (options) {
  ...
  // Legends won't show correctly inside Allura
  /* defaults.open.data = [{label:"opened", data: data.open}];
  ...
  defaults.open.data = data.open;
  defaults.change.data = data.change;
  defaults.close.data = data.close;
  defaults.openers.data = data.openers;
  defaults.closers.data = data.closers;
  defaults.changers.data = data.changers;
